...
<li class="nav-item">
    ...
    <div id="main" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">tag</a>
            <a class="collapse-item" href="cards.html">bransh</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagenturan"
        aria-expanded="true" aria-controls="pagenturan">
        <i class="fas fa-fw fa-wrench"></i>
        <span>Pangaturan</span>
    </a>
    <div id="pagenturan" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-animation.html">testing</a>
        </div>
    </div>
</li>
